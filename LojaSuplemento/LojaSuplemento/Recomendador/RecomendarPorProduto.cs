...
{
    class RecomendarPorProduto : BaseRecomendador
    {
        List<Produto> produtosRecomendados = new List<Produto>();
        public override List<SimilaridadeCliente> ComparaClientes(Cliente thisUser, BancoDadosClientes bancoDadosClientes)
        {
        ...
        public override List<Produto> getHistoricoClienteMaiorAfinidade(List<SimilaridadeCliente> clientesParecidos, BancoDadosClientes bancoDadosClientes)
        {
        ...
        public override List<Produto> ListaProdutosRecomendados(Cliente cliente, List<Produto> historicoClienteMaiorAfinidade)
        {      
